...
$(function(){
	$("#btnList").click(function(){
		location.href="/spring04/board/list.do";
	});
	listReply("1"); //댓글 1페이지
	...
	$("#btnUpdate").click(function(){
		...
		document.form1.action="/spring04/board/update.do";
		document.form1.submit();
	});
	$("#btnDelete").click(function(){
		if(confirm("삭제하시겠습니까?")){
			document.form1.action="/spring04/board/delete.do";
			document.form1.submit();
		}
	});	
});
function getFileInfo(file_name){
	var get_link="/spring04/upload/display_file?file_name="+file_name;
...
function listAttach(){
	$.ajax({
		type:"post",
		url:"/spring04/board/list_attach/${dto.idx}",
...
function listReply(num){
	console.log("num:"+num);
	$.ajax({
		url:"/spring04/reply/list.do?board_idx=${dto.idx}&curPage="+num,
		success: function(result){
