...
$(function(){
	$("#btnList").click(function(){
		location.href="/spring04/shop/product/list.do";
	});
...
<c:choose>
	...
	<c:otherwise>
		<form method="post" action="/spring04/shop/cart/update.do">
		...
		<c:forEach var="row" items="${map.list}"> 
			<tr>
				...
				<td>${row.money}</td>
				<td><a href="/spring04/shop/cart/delete.do?cart_id=${row.cart_id}">삭제</a>
			</tr>
		</c:forEach>
			<tr>
