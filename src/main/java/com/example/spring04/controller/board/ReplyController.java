package com.example.spring04.controller.board;
...
import com.example.spring04.model.board.ReplyDAO;
import com.example.spring04.model.board.ReplyDTO;
import com.example.spring04.service.board.PageUtil;
...
public class ReplyController {
	...
	public @ResponseBody List<ReplyDTO> list_json(@RequestParam(defaultValue = "1") int curPage, @RequestParam int idx) { // json
																																																												// 형식으로
																																																												// 댓글
																																																												// 목록을
																																																												// 리턴
